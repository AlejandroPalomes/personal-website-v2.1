...
<div class="main overflow-hidden">
        <div id="header" class="main__header vw-100 vh-100 d-flex flex-column flex-lg-row align-items-center">
            <div class="main__header__personal h-100 mt-5 mt-lg-0 d-flex flex-column justify-content-end">
                <div class="w-100 h-75">
                    ...
                    <p class="d-none d-lg-inline-block mb-4">
                        ...
                        <br><br>
                        I’ve discovered in coding a passion which enriches my inner desire to keep learning alongside my career growth.
                        <br><br>
                    ...
                    <div class="d-none d-lg-block main__header__links">
                        ...
                        <a href="https://www.instagram.com/shailfidd/" class="mr-1">
                            <svg height="25pt"  width="25pt" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="https://github.com/AlejandroPalomes" class="mr-1">
                            <svg height="25pt"  width="25pt" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="main__header__image d-flex align-items-end justify-content-center">
                <img height="90%" src="https://res.cloudinary.com/hf5b7vlzm/image/upload/v1604280764/other/APALOMES_BUSTO_qmy2j1.png" alt="Profile picture">
            </div>
        </div>
